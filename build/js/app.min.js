let productInfo=[{id:1,category:"Vegetable",imgSrc:"./assets/images/product-photo-1.png",title:"Calabrese Broccoli",price:"$20.00",discountPrice:"$13.00",rating:4.7},{id:2,category:"Fresh",imgSrc:"./assets/images/product-photo-2.png",title:"Fresh Banana Fruits",price:"$20.00",discountPrice:"$14.00",rating:5},{id:3,category:"Millets",imgSrc:"./assets/images/product-photo-3.png",title:"White Nuts",price:"$20.00",discountPrice:"$15.00",rating:4.5},{id:4,category:"Vegetable",imgSrc:"./assets/images/product-photo-4.png",title:"Vegan Red Tomato",price:"$20.00",discountPrice:"$17.00",rating:4},{id:5,category:"Health",imgSrc:"./assets/images/product-photo-5.png",title:"Mung Bean",price:"$20.00",discountPrice:"$11.00",rating:3.3},{id:6,category:"Nuts",imgSrc:"./assets/images/product-photo-6.png",title:"Brown Hazelnut",price:"$20.00",discountPrice:"$12.00",rating:4.6},{id:7,category:"Fresh",imgSrc:"./assets/images/product-photo-7.png",title:"Eggs",price:"$20.00",discountPrice:"$17.00",rating:4.3},{id:8,category:"Fresh",imgSrc:"./assets/images/product-photo-8.png",title:"Zelco Suji Elaichi Rusk",price:"$20.00",discountPrice:"$15.00",rating:4.7},{id:9,category:"Fruit",imgSrc:"./assets/images/product-photo-9.png",title:"Organic Apples",price:"$25.00",discountPrice:"$20.00",rating:4.9},{id:10,category:"Dairy",imgSrc:"./assets/images/product-photo-10.png",title:"Greek Yogurt",price:"$15.00",discountPrice:"$10.00",rating:4.8},{id:11,category:"Vegetable",imgSrc:"./assets/images/product-photo-11.png",title:"Fresh Spinach",price:"$18.00",discountPrice:"$12.00",rating:4.6},{id:12,category:"Grains",imgSrc:"./assets/images/product-photo-12.png",title:"Brown Rice",price:"$22.00",discountPrice:"$16.00",rating:4.4},{id:13,category:"Herbs",imgSrc:"./assets/images/product-photo-13.png",title:"Fresh Basil",price:"$10.00",discountPrice:"$8.00",rating:4.7},{id:14,category:"Snack",imgSrc:"./assets/images/product-photo-14.png",title:"Trail Mix",price:"$18.00",discountPrice:"$14.00",rating:4.5},{id:15,category:"Beverage",imgSrc:"./assets/images/product-photo-15.png",title:"Green Tea",price:"$12.00",discountPrice:"$9.00",rating:4.8},{id:16,category:"Frozen",imgSrc:"./assets/images/product-photo-16.png",title:"Frozen Berries",price:"$15.00",discountPrice:"$11.00",rating:4.6}];document.addEventListener("DOMContentLoaded",function(){var e=document.querySelector(".sec-4-cards"),t=document.querySelector(".sec-6-cards");function r(r,e,i){e.forEach(e=>{t=100*e.rating/5;var t,e=`
    ...
    `;r.innerHTML+=e})}r(e,productInfo,4),r(t,productInfo.slice(5,9),6);e=document.querySelector("header button.burger");let i=document.querySelectorAll("header button.burger img");e.addEventListener("click",function(){i.forEach(e=>{e.classList.toggle("hidden")}),document.querySelector("header .mobile-menu .nav").classList.toggle("visible")});document.querySelector("header button.search-btn").addEventListener("click",function(){document.querySelector("header .mobile-menu .features .search").classList.toggle("expanded")}),new Glide(".sec5-cards",{type:"carousel",startAt:0,perView:1}).mount();let c=document.querySelector(".modals-wrapper");t=document.querySelectorAll(".modal-close-btn");["sec-8-card-1-btn","sec-8-card-2-btn","cart-modal-btn"].forEach(e=>{e=document.getElementById(e);let t=e.getAttribute("data-modal-id"),r=document.getElementById(t);e.addEventListener("click",function(){c.classList.add("visible"),r.classList.add("visible"),document.querySelector("body").classList.add("overflow"),header.style.zIndex="0","cart-modal"===t&&f()})}),t.forEach(e=>{e.addEventListener("click",function(){c.classList.remove("visible"),this.parentElement.classList.remove("visible"),document.querySelector("body").classList.remove("overflow"),header.style.zIndex="10"})});let s=document.getElementById("load-more-cards"),o=document.querySelectorAll(".sec-4-card"),a=l(),n=a,d=a/2;function l(){return Array.from(o).filter(e=>"none"!==getComputedStyle(e).display).length}window.addEventListener("resize",((e,t)=>{let r;return function(){clearTimeout(r),r=setTimeout(()=>{e.apply(this,arguments)},t)}})(()=>{a=l(),n=a,d=a/2},200)),s.addEventListener("click",function(){if(n<productInfo.length){var e=productInfo.length-n,t=Math.min(d,e);for(let e=n;e<n+t&&e<productInfo.length;e++)o[e].style.display="block";(n+=t)>=productInfo.length&&(s.querySelector("span").textContent="Load Less")}else{n=a;for(let e=productInfo.length-1;e>=a;e--)o[e].style.display="none";s.querySelector("span").textContent="Load More";e=document.querySelector(".sec-4").getBoundingClientRect().top+window.scrollY;window.scrollTo({top:e+60,behavior:"smooth"})}}),emailjs.init({publicKey:"P5fBc6Y05XLa5Mvz2"});e=document.getElementById("form-submit");let u=document.getElementById("email-input"),g=new AWN({position:"top-right",maxNotifications:3}),p=(e.addEventListener("click",function(e){e.preventDefault();var e=u.value,t=/^(([^<>()[\].,;:\s@"]+(\.[^<>()[\].,;:\s@"]+)*)|(".+"))@(([^<>()[\].,;:\s@"]+\.)+[^<>()[\].,;:\s@"]{2,})$/iu.test(e);t?(emailjs.send("service_k6fk4s9","template_b7c7dwr",{user_email:e}),u.value=""):g.alert("Please type correct email address!")}),JSON.parse(localStorage.getItem("selectedProducts"))||[]),m=document.querySelectorAll(".product-card .buy");function h(){let r=JSON.parse(localStorage.getItem("selectedProducts"))||[];document.querySelector("header .features .cart p span").textContent=r.length,m.forEach(e=>{var t=e.parentElement.getAttribute("data-product-id");e.classList.toggle("active",r.includes(t))})}function y(e){e.preventDefault();let t=this.parentElement.getAttribute("data-product-id");this.classList.toggle("active"),this.classList.contains("active")?p.push(t):p=p.filter(e=>e!==t),localStorage.setItem("selectedProducts",JSON.stringify(p)),h()}function f(){let t=document.querySelector("#cart-modal ul");t.innerHTML=p.map(e=>{var t;return`
